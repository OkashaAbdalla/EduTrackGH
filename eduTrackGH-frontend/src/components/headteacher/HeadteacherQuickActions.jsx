...
const actions = [
  ...
  },
  {
    ...
    iconBg: 'bg-indigo-600 dark:bg-indigo-600',
    iconPath:
        ...
        <Link key={a.to} to={a.to}>
          <Card variant="action" hover className="p-6 group cursor-pointer h-full">
            <div className="flex items-center space-x-5">
              <div
                className={`w-16 h-16 ${a.iconBg} rounded-xl flex items-center justify-center shrink-0 group-hover:opacity-95 transition-opacity duration-300`}
              >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-gray-600 dark:text-dashboard-muted">{a.description}</p>
