...
const HeadteacherRegisterStudentForm = ({ isOpen, onClose, classrooms = [], onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const result = await studentService.registerStudentAsHeadteacher(formData);
      if (result.success) {
        ...
        showToast(result.message || 'Failed to register student', 'error');
      }
    } catch (error) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Register Student (Headteacher)">
...
export default HeadteacherRegisterStudentForm;
